    ...
    render() {
        ...
        return (
            ...
            <div className="forum-details-headers">
                <h1 className="forum-details-headers__header">{this.state.selectedForum.title}</h1>
                <h3 className="forum-details-headers__description">{this.state.selectedForum.description} by: {this.state.selectedForum.createdBy}</h3>
            </div>
